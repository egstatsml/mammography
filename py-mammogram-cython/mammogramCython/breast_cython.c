...
#define __PYX_HAVE__breast_cython
#define __PYX_HAVE_API__breast_cython
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_int_t __pyx_t_13breast_cython_DTYPE_t;
/* None.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'breast_cython' */
...
#define __Pyx_MODULE_NAME "breast_cython"
int __pyx_module_is_main_breast_cython = 0;

/* Implementation of 'breast_cython' */
...
static const char __pyx_k_breast_cython[] = "breast_cython";
static const char __pyx_k_cy_search_prev[] = "cy_search_prev";
static const char __pyx_k_recently_found[] = "recently_found";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_home_ethan_thesis_py_breast_cyt[] = "/home/ethan/thesis/py-breast-cython/breast-cython/breast_cython.pyx";
...
static PyObject *__pyx_n_s_breast_cython;
static PyObject *__pyx_n_s_count;
static PyObject *__pyx_n_s_cy_search_prev;
static PyObject *__pyx_kp_s_home_ethan_thesis_py_breast_cyt;
...
static PyObject *__pyx_n_s_recently_found;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_x;
static PyObject *__pyx_n_s_y;
static PyObject *__pyx_pf_13breast_cython_cy_search_prev(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_l_y, PyArrayObject *__pyx_v_l_x, int __pyx_v_y, int __pyx_v_x, int __pyx_v_count); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_13breast_cython_1cy_search_prev(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_13breast_cython_1cy_search_prev = {"cy_search_prev", (PyCFunction)__pyx_pw_13breast_cython_1cy_search_prev, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_13breast_cython_1cy_search_prev(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_l_y = 0;
  PyArrayObject *__pyx_v_l_x = 0;
  int __pyx_v_y;
  int __pyx_v_x;
  int __pyx_v_count;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cy_search_prev (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_l_y,&__pyx_n_s_l_x,&__pyx_n_s_y,&__pyx_n_s_x,&__pyx_n_s_count,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_l_y)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_l_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_search_prev", 1, 5, 5, 1); __PYX_ERR(0, 26, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_search_prev", 1, 5, 5, 2); __PYX_ERR(0, 26, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_search_prev", 1, 5, 5, 3); __PYX_ERR(0, 26, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_count)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_search_prev", 1, 5, 5, 4); __PYX_ERR(0, 26, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cy_search_prev") < 0)) __PYX_ERR(0, 26, __pyx_L3_error)
      }
    ...
    __pyx_v_l_y = ((PyArrayObject *)values[0]);
    __pyx_v_l_x = ((PyArrayObject *)values[1]);
    __pyx_v_y = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    __pyx_v_x = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    __pyx_v_count = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_count == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cy_search_prev", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 26, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("breast_cython.cy_search_prev", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_l_y), __pyx_ptype_5numpy_ndarray, 1, "l_y", 0))) __PYX_ERR(0, 26, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_l_x), __pyx_ptype_5numpy_ndarray, 1, "l_x", 0))) __PYX_ERR(0, 26, __pyx_L1_error)
  __pyx_r = __pyx_pf_13breast_cython_cy_search_prev(__pyx_self, __pyx_v_l_y, __pyx_v_l_x, __pyx_v_y, __pyx_v_x, __pyx_v_count);
...
static PyObject *__pyx_pf_13breast_cython_cy_search_prev(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_l_y, PyArrayObject *__pyx_v_l_x, int __pyx_v_y, int __pyx_v_x, int __pyx_v_count) {
  int __pyx_v_recently_found;
  int __pyx_v_lim;
  int __pyx_v_jj;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_l_x;
  __Pyx_Buffer __pyx_pybuffer_l_x;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_l_y;
  __Pyx_Buffer __pyx_pybuffer_l_y;
  ...
  __Pyx_RefNannySetupContext("cy_search_prev", 0);
  __pyx_pybuffer_l_y.pybuffer.buf = NULL;
  __pyx_pybuffer_l_y.refcount = 0;
  __pyx_pybuffernd_l_y.data = NULL;
  __pyx_pybuffernd_l_y.rcbuffer = &__pyx_pybuffer_l_y;
  __pyx_pybuffer_l_x.pybuffer.buf = NULL;
  __pyx_pybuffer_l_x.refcount = 0;
  __pyx_pybuffernd_l_x.data = NULL;
  __pyx_pybuffernd_l_x.rcbuffer = &__pyx_pybuffer_l_x;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_l_y.rcbuffer->pybuffer, (PyObject*)__pyx_v_l_y, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int16_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 26, __pyx_L1_error)
  }
  __pyx_pybuffernd_l_y.diminfo[0].strides = __pyx_pybuffernd_l_y.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_l_y.diminfo[0].shape = __pyx_pybuffernd_l_y.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_l_x.rcbuffer->pybuffer, (PyObject*)__pyx_v_l_x, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int16_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 26, __pyx_L1_error)
  }
  __pyx_pybuffernd_l_x.diminfo[0].strides = __pyx_pybuffernd_l_x.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_l_x.diminfo[0].shape = __pyx_pybuffernd_l_x.rcbuffer->pybuffer.shape[0];

  /* "breast_cython.pyx":28
 * def cy_search_prev(np.ndarray[dtype=np.int16_t, ndim=1] l_y, np.ndarray[dtype=np.int16_t, ndim=1] l_x, int y, int x, int count):
 * 
 *     cdef bint recently_found = False             # <<<<<<<<<<<<<<
 *     cdef int lim
 *     cdef int jj
 */
  __pyx_v_recently_found = 0;

  /* "breast_cython.pyx":32
 *     cdef int jj
 * 
 *     if(count < 20):             # <<<<<<<<<<<<<<
 *         lim = len(l_y) + 1
 *     else:
 */
  __pyx_t_1 = ((__pyx_v_count < 20) != 0);
  if (__pyx_t_1) {

    /* "breast_cython.pyx":33
 * 
 *     if(count < 20):
 *         lim = len(l_y) + 1             # <<<<<<<<<<<<<<
 *     else:
 *         lim = 20
 */
    __pyx_t_2 = PyObject_Length(((PyObject *)__pyx_v_l_y)); if (unlikely(__pyx_t_2 == -1)) __PYX_ERR(0, 33, __pyx_L1_error)
    __pyx_v_lim = (__pyx_t_2 + 1);
 ...
 *             recently_found = True
 */
  __pyx_t_3 = (__pyx_v_count - __pyx_v_lim);
  for (__pyx_t_4 = __pyx_v_count; __pyx_t_4 > __pyx_t_3; __pyx_t_4-=1) {
    __pyx_v_jj = __pyx_t_4;

    /* "breast_cython.pyx":38
 * 
 *     for jj in range(count,count-lim,-1):
 *         if(l_y[jj] == y) & (l_x[jj] == x):             # <<<<<<<<<<<<<<
 *             recently_found = True
 ...
 */
    ...
    if (__pyx_t_5 < 0) __pyx_t_5 += __pyx_pybuffernd_l_y.diminfo[0].shape;
    __pyx_t_6 = __pyx_v_jj;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_pybuffernd_l_x.diminfo[0].shape;
    __pyx_t_1 = ((((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int16_t *, __pyx_pybuffernd_l_y.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_l_y.diminfo[0].strides)) == __pyx_v_y) & ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int16_t *, __pyx_pybuffernd_l_x.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_l_x.diminfo[0].strides)) == __pyx_v_x)) != 0);
    if (__pyx_t_1) {

      /* "breast_cython.pyx":39
 *     for jj in range(count,count-lim,-1):
 *         if(l_y[jj] == y) & (l_x[jj] == x):
 *             recently_found = True             # <<<<<<<<<<<<<<
 *             break
 * 
 */
      __pyx_v_recently_found = 1;

      /* "breast_cython.pyx":40
 *         if(l_y[jj] == y) & (l_x[jj] == x):
 *             recently_found = True
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_7 = __Pyx_PyBool_FromLong(__pyx_v_recently_found); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 42, __pyx_L1_error)
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_l_x.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_l_y.rcbuffer->pybuffer);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_breast_cython, __pyx_k_breast_cython, sizeof(__pyx_k_breast_cython), 0, 0, 1, 1},
  {&__pyx_n_s_count, __pyx_k_count, sizeof(__pyx_k_count), 0, 0, 1, 1},
  {&__pyx_n_s_cy_search_prev, __pyx_k_cy_search_prev, sizeof(__pyx_k_cy_search_prev), 0, 0, 1, 1},
  {&__pyx_kp_s_home_ethan_thesis_py_breast_cyt, __pyx_k_home_ethan_thesis_py_breast_cyt, sizeof(__pyx_k_home_ethan_thesis_py_breast_cyt), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_recently_found, __pyx_k_recently_found, sizeof(__pyx_k_recently_found), 0, 0, 1, 1},
 ...
 *     cdef bint recently_found = False
 */
  __pyx_tuple__7 = PyTuple_Pack(8, __pyx_n_s_l_y, __pyx_n_s_l_x, __pyx_n_s_y, __pyx_n_s_x, __pyx_n_s_count, __pyx_n_s_recently_found, __pyx_n_s_lim, __pyx_n_s_jj); if (unlikely(!__pyx_tuple__7)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(5, 0, 8, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_ethan_thesis_py_breast_cyt, __pyx_n_s_cy_search_prev, 26, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initbreast_cython(void); /*proto*/
PyMODINIT_FUNC initbreast_cython(void)
#else
PyMODINIT_FUNC PyInit_breast_cython(void); /*proto*/
PyMODINIT_FUNC PyInit_breast_cython(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_breast_cython(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("breast_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_breast_cython) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "breast_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "breast_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef bint recently_found = False
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_13breast_cython_1cy_search_prev, NULL, __pyx_n_s_breast_cython); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cy_search_prev, __pyx_t_2) < 0) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init breast_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init breast_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
