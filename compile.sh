...
cython -a $TARGET.pyx
ls ./
ls ./anaconda/pkgs/numpy*/lib/python2.7/site-packages/numpy/core/include/numpy/
...
gcc -shared -pthread -fPIC -fwrapv -O2 -Wall -fno-strict-aliasing       -I./anaconda/include/python2.7 -I/anaconda/lib/python2.7/site-packages/numpy/core/include/ -o $TARGET.so $TARGET.c
