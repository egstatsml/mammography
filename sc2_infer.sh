...
echo "Inferece for Sub Challenge 2"
echo "Running Inference Script"
python main_thread.py -t -p -i $INPUT_DIR -s $SAVE_IMAGE_DIR -l $LOG_DIR -m $METADATA_DIR --model $SAVE_DIR_MODEL_FILES --sub 2 --pca 20
