...
echo "Copying the trained model file into the model_state directory"
cp ./model_file $MODEL_STATE_DIR/
...
python main_thread.py -v -p -i $INPUT_DIR -s $SAVE_IMAGE_DIR -l $LOG_DIR -m $METADATA_DIR --model $MODEL_STATE_DIR --sub 1 --pca 20 -c 
